        ...
        return (
            <div className={cx(`form`)}>
                <Dialog>
                    ...
                    <DialogContents>
                        <Material width={w} height={h} borderRadius={Convert.circleToBorderRadius(new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.0), { width: w, height: h })} elevation={3} zoom={1}>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.05)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.red.n300)}>
                                <span className={mdc(colors.text.black.darker)}>0%</span>
                            </Surface>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.0)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.indigo.n300)}>
                                <span className={mdc(colors.text.white.darker)}>0%</span>
                    ...
                    <DialogContents>
                        <Material width={w} height={h} borderRadius={Convert.circleToBorderRadius(new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.25), { width: w, height: h })} elevation={3} zoom={1}>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.30)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.red.n300)}>
                                <span className={mdc(colors.text.black.darker)}>25%</span>
                            </Surface>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.25)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.indigo.n300)}>
                                <span className={mdc(colors.text.white.darker)}>25%</span>
                    ...
                    <DialogContents>
                        <Material width={w} height={h} borderRadius={Convert.circleToBorderRadius(new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.5), { width: w, height: h })} elevation={3} zoom={1}>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.55)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.red.n300)}>
                                <span className={mdc(colors.text.black.darker)}>50%</span>
                            </Surface>
                            <Surface width={w} height={h} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.5)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.indigo.n300)}>
                                <span className={mdc(colors.text.white.darker)}>50%</span>
                    ...
                    <DialogContents>
                        <Material width={120} height={40} borderRadius={Convert.circleToBorderRadius(new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.75), { width: w, height: h })} elevation={3} zoom={1}>
                            <Surface width={120} height={40} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.80)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.red.n300)}>
                                <span className={mdc(colors.text.black.darker)}>75%</span>
                            </Surface>
                            <Surface width={120} height={40} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 0.75)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.indigo.n300)}>
                                <span className={mdc(colors.text.white.darker)}>75%</span>
                    ...
                    <DialogContents>
                        <Material width={120} height={40} borderRadius={Convert.circleToBorderRadius(new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 1.0), { width: w, height: h })} elevation={3} zoom={1}>
                            <Surface width={120} height={40} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 1.05)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.red.n300)}>
                                <span className={mdc(colors.text.black.darker)}>100%</span>
                            </Surface>
                            <Surface width={120} height={40} circle={new Circle(w*0.5, h*0.5, Math.sqrt(w * w * .25 + h * h * .25) * 1.0)} opacity={1} offset={Translate.empty} className={mdc(colors.bg.indigo.n300)}>
                                <span className={mdc(colors.text.white.darker)}>100%</span>
